...
class RoundListFragment : Fragment() {
    ...
    interface OnRoundListFragmentInteractionListener{
        fun onRoundSelected(round: Round, bol: Boolean)
    }

    /*Metodo onCreate del fragmento de lista de partidas*/
    ...
    /*Metodo que rellena el fragment de lista de partidas*/
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView.apply {
            ...
            update(ERSettingsActivity.getPlayerUUID(context!!)){round, bol -> listener?.onRoundSelected(round, bol)}
        }
    }
    ...
    override fun onResume(){
        super.onResume()
        recyclerView.update(ERSettingsActivity.getPlayerUUID(context!!)){round, bol -> listener?.onRoundSelected(round, bol)}
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment RoundListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RoundListFragment().apply {
